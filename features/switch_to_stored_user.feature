Feature: Switch to stored user
    ...
    Scenario Outline: Switch to stored user
        ...
        And user "<selected_user>" should be selected in "global" scope

        Scenarios: Existing user match
            | request   | selected_user                           | output                                                          |
            | raphe     | Raphe Rackstraw <rackstraw@github.com>  | Switched global user to Raphe Rackstraw <rackstraw@github.com>  |
            | git       | Raphe Rackstraw <rackstraw@github.com>  | Switched global user to Raphe Rackstraw <rackstraw@github.com>  |
            | rr        | Raphe Rackstraw <rackstraw@github.com>  | Switched global user to Raphe Rackstraw <rackstraw@github.com>  |
